...
const s85 = {
  ...
  problems: [
    ...
    {
      q: 'Which equation matches the graph shown?',
      fig: {
        view: [-2, -4, 6, 3],
        grid: true,
        elems: [
          { t: 'line', a: [0, -2], b: [4, 1] },
          { t: 'point', p: [0, -2], label: '(0, -2)', dx: -24, dy: 12 },
          { t: 'point', p: [4, 1], label: '(4, 1)', dx: 12, dy: -10 },
        ],
      },
      choices: [
        '$y = \\frac{4}{3}x - 2$',
      ...
      answer: 2,
      solution: 'The line crosses the $y$-axis at $(0, -2)$, so $b = -2$. From $(0, -2)$ to $(4, 1)$ it climbs $3$ while running $4$, so $m = \\frac{3}{4}$. Equation: $y = \\frac{3}{4}x - 2$. Check $(4, 1)$: $3 - 2 = 1$. ✓ (The first choice swaps rise and run; the second makes the line fall when the picture clearly climbs; the last flips the sign of the intercept.)',
    },
    {
...
const challenge = [
  ...
  {
    q: 'What is the slope of the line graphed below?',
    fig: {
      view: [-5, -4, 4, 4],
      grid: true,
      elems: [
        { t: 'line', a: [-4, 1], b: [2, -3] },
        { t: 'point', p: [-4, 1], label: '(-4, 1)', dx: 6, dy: -12 },
        { t: 'point', p: [2, -3], label: '(2, -3)', dx: 10, dy: 14 },
      ],
    },
    choices: ['$\\frac{2}{3}$', '$-\\frac{3}{2}$', '$-\\frac{2}{3}$', '$\\frac{3}{2}$'],
    answer: 2,
    solution: 'Use the marked points $(-4, 1)$ and $(2, -3)$. Rise: $-3 - 1 = -4$. Run: $2 - (-4) = 6$. Slope $= \\frac{-4}{6} = -\\frac{2}{3}$. Check it forward: starting at $(-4, 1)$ and taking two steps of run $3$ and drop $2$ lands on $(-1, -1)$ and then $(2, -3)$ — the second marked point. ✓ The line falls gently to the right, so a negative slope smaller than $1$ in size matches the picture. (The choice $-\\frac{3}{2}$ divides run by rise; $\\frac{2}{3}$ has the right size but the wrong sign; $\\frac{3}{2}$ makes both mistakes at once.)',
  },
  {
