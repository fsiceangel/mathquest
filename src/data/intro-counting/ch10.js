...
const challenge = [
  ...
  {
    q: 'Inside a square of side $12$, two $6$ by $6$ squares are painted: one fills the bottom-left corner, and the other is centered at the center of the big square, as shown. A point is chosen at random in the big square. What is the probability that it lies in neither painted square?',
    fig: {
      view: frame(12, 12),
      elems: [
        box(12, 12),
        { t: 'poly', pts: [[0, 0], [6, 0], [6, 3], [9, 3], [9, 9], [3, 9], [3, 6], [0, 6]] },
        box(6, 6),
        box(6, 6, 3, 3),
        lab(9, 0, '12', 0, 16),
        lab(3, 0, '6', 0, 16),
    ...
    choices: ['$\\frac{1}{2}$', '$\\frac{7}{16}$', '$\\frac{9}{16}$', '$\\frac{5}{8}$'],
    answer: 2,
    solution: 'The painted squares overlap on the $3$ by $3$ square from $(3, 3)$ to $(6, 6)$, so the painted area is $36 + 36 - 9 = 63$ and the unpainted area is $144 - 63 = 81$. The probability is $\\frac{81}{144} = \\frac{9}{16}$. Forgetting the overlap gives $144 - 72 = 72$ and $\\frac{1}{2}$; $\\frac{7}{16}$ is the painted share, the complement.',
  },
  {
