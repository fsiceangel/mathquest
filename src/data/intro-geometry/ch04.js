...
const challenge = [
  ...
  },
  {
    ...
    fig: {
      ...
      elems: [
        { t: 'poly', pts: [[0, 0], [13, 0], [9, 6], [2, 6]] },
        { t: 'seg', a: [2, 6], b: [2, 0], dash: true },
        { t: 'right', at: [2, 0], from: [2, 6], to: [13, 0] },
        { t: 'label', p: [6.5, -0.7], text: '13' },
        { t: 'label', p: [5.5, 6.5], text: '7' },
        { t: 'label', p: [1.4, 3], text: '6' },
      ],
    },
    choices: ['$120$', '$78$', '$60$', '$42$'],
    answer: 2,
    solution: 'Average the parallel sides and multiply by the height: $\\frac{1}{2}(13 + 7) \\cdot 6 = 10 \\cdot 6 = 60$. Skipping the $\\frac{1}{2}$ gives $120$, and $78 = 13 \\cdot 6$ uses only the long base — the average is the heart of the formula.',
  },
  {
