...
const s102 = [
  ...
  [
    ...
    },
    {
      ...
      answer: 2,
      solution:
        'The first condition is the stretch $[2, 12]$ and the second is $[6, 14]$. Both hold exactly on the overlap $[6, 12]$, a stretch of length $6$, so the probability is $\\frac{6}{15} = \\frac{2}{5}$ ✓. Second route, by complement: the pair fails when $x < 6$ (which breaks the second condition, and includes everything that breaks the first on the left) or $x > 12$ (which breaks the first): stretches of lengths $6$ and $3$, failure probability $\\frac{9}{15} = \\frac{3}{5}$, so the answer is $1 - \\frac{3}{5} = \\frac{2}{5}$ ✓. USING THE FIRST CONDITION ALONE gives $\\frac{10}{15} = \\frac{2}{3}$ ✗. TAKING THE UNION $[2, 14]$ INSTEAD OF THE OVERLAP gives $\\frac{12}{15} = \\frac{4}{5}$ ✗. USING THE SECOND ALONE gives $\\frac{8}{15}$ ✗.',
    },
    {
