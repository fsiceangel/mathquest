  ...
  [
    {
      ...
      answer: '$\\frac{13}{15}$',
      solution:
        'Only the $13$ spades and the $2$ red aces matter; the other $37$ cards are scenery. Whichever of those $15$ cards comes first decides the question, and by symmetry each of the $15$ is equally likely to be first, so the probability is $\\frac{13}{15}$ ✓. The complement agrees: the event fails exactly when a red ace leads those $15$ cards, which by the same symmetry has probability $\\frac{2}{15}$, and $1 - \\frac{2}{15} = \\frac{13}{15}$ ✓. COUNTING ALL FOUR ACES gives $\\frac{13}{17}$; the black aces cannot decide this question either way and must be thrown out with the rest of the scenery ✗.',
    },
    {
