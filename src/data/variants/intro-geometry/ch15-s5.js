  ...
  [
    {
      ...
      answer: 1,
      solution:
        'The canvas is the lateral surface, which unrolls into a sector of area $\\pi r \\ell$, so $\\pi \\cdot 7 \\cdot \\ell = 175\\pi$ and the slant height is $\\ell = 25$. The radius, the height and the slant meet in a right triangle with the slant as the hypotenuse, so $h = \\sqrt{25^2 - 7^2} = \\sqrt{625 - 49} = \\sqrt{576} = 24$, and $V = \\frac{1}{3}\\pi \\cdot 49 \\cdot 24 = 392\\pi$ ✓. Check a second, independent way by running the chain backwards from the answer: an interior of $392\\pi$ standing on ground of radius $7$ forces $h = \\frac{3 \\cdot 392}{49} = 24$, which puts the slant at $\\sqrt{49 + 576} = 25$ and the canvas at $\\pi \\cdot 7 \\cdot 25 = 175\\pi$ — exactly the piece the tent was cut from ✓. (The choice $1176\\pi$ is DROPPING THE $\\frac{1}{3}$ and measuring the cylinder instead ✗; the choice $\\frac{1225\\pi}{3}$ is USING THE SLANT $25$ AS THE HEIGHT ✗; the choice $294\\pi$ is SUBTRACTING THE RADIUS FROM THE SLANT, $25 - 7$, instead of using the right triangle ✗.)',
    },
    {
      ...
      answer: 2,
      solution:
        'The curved surface is $\\pi r \\ell$, so $\\pi \\cdot 12 \\cdot \\ell = 156\\pi$ and $\\ell = 13$. The slant is the hypotenuse of the right triangle built on the radius and the height, so $h = \\sqrt{13^2 - 12^2} = \\sqrt{25} = 5$, and $V = \\frac{1}{3}\\pi \\cdot 144 \\cdot 5 = 240\\pi$ ✓. Check a second, independent way by working backwards from the answer: a volume of $240\\pi$ over a base of radius $12$ needs $h = \\frac{3 \\cdot 240}{144} = 5$, so the slant is $\\sqrt{144 + 25} = 13$ and the curved surface is $\\pi \\cdot 12 \\cdot 13 = 156\\pi$, matching the given area ✓. (The choice $48\\pi$ is SUBTRACTING THE RADIUS FROM THE SLANT, $13 - 12$, instead of using the right triangle ✗; the choice $624\\pi$ is USING THE SLANT $13$ AS THE HEIGHT ✗; the choice $720\\pi$ is DROPPING THE $\\frac{1}{3}$ ✗.)',
    },
    {
