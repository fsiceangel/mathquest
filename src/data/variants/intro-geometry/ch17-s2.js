...
const s172 = [
  ...
  [
    ...
    },
    {
      ...
      answer: 2,
      solution:
        'Route one, feed each point into the left side and look for exactly $100$: $(-2, 0)$ gives $3^2 + (-1)^2 = 10$; $(11, 7)$ gives $16^2 + 6^2 = 292$; $(1, 9)$ gives $6^2 + 8^2 = 36 + 64 = 100$; $(9, 1)$ gives $14^2 + 0^2 = 196$. Only $(1, 9)$ hits $100$ ✓. Check a second, independent way, by measuring each trip out from the center $(-5, 1)$ and comparing it with the radius $\\sqrt{100} = 10$: the trip to $(1, 9)$ runs $6$ right and $8$ up, the legs of a $6$-$8$-$10$ right triangle, so that point stands exactly $10$ from the center. The trip to $(-2, 0)$ is $3$ right and $1$ down, nowhere near $10$; the trip to $(9, 1)$ is a straight $14$ to the right, too far; the trip to $(11, 7)$ is $16$ right and $6$ up, farther still. The point at radius distance is $(1, 9)$ ✓. (The choice $(-2, 0)$ is COMPARING THE LEFT SIDE WITH THE RADIUS $10$ INSTEAD OF WITH $r^2 = 100$ ✗; the choice $(11, 7)$ is ADDING THE CENTER’S COORDINATES INSTEAD OF SUBTRACTING THEM, since $(11 - 5)^2 + (7 + 1)^2 = 100$ ✗; the choice $(9, 1)$ is READING THE CORRECT POINT WITH ITS COORDINATES IN THE WRONG ORDER ✗.)',
    },
  ],
