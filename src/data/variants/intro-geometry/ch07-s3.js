...
const s73 = [
  ...
  [
    ...
    },
    {
      ...
      answer: 3,
      solution:
        'Each angle bisector is the set of points equidistant from the two sides of its angle, so the crossing point of all three inherits equal perpendicular distances to all three sides — that shared distance is the inradius ✓. Check a second, independent way by asking what circle each point owns: the circumcenter’s equal VERTEX distances make it the center of the circle through the corners, while the incenter’s equal SIDE distances make it the center of the circle tucked against the edges; two different centers, two different jobs, and the incenter’s job is sides ✓. ("Choosing angles" is not a distance at all — an angle has a measure, not a location to be far from ✗; "medians" is MEASURING TO THE WRONG SEGMENTS ✗; "vertices" is HANDING THE JOB TO THE CIRCUMCENTER, the match Deshawn already used ✗.)',
    },
  ],
