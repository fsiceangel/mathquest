...
const s26 = [
  ...
  [
    ...
    },
    {
      ...
      answer: 3,
      solution:
        'One exterior angle does the work of two interior ones: $\\angle ACE = \\angle A + \\angle B = 39^\\circ + 88^\\circ = 127^\\circ$ ✓. Check a second, independent way without adding the remotes: the interior angle at $C$ is $180^\\circ - 39^\\circ - 88^\\circ = 53^\\circ$, and it forms a linear pair with $\\angle ACE$ along the straight line through $B$, $C$, and $E$, so $\\angle ACE = 180^\\circ - 53^\\circ = 127^\\circ$ ✓. (Choosing $141^\\circ$ is SUPPLEMENTING A REMOTE ANGLE, $180^\\circ - 39^\\circ$ ✗; $49^\\circ$ is SUBTRACTING THE REMOTES INSTEAD OF ADDING ✗, and it is smaller than the remote $88^\\circ$, which gives the mistake away at once; $53^\\circ$ is ANSWERING WITH THE INTERIOR ANGLE AT THE VERTEX ✗.)',
    },
  ],
  ...
  [
    ...
    },
    {
      ...
      answer: 3,
      solution:
        'Points $A$, $B$, and $E$ lie on one straight line, so the interior angle at $B$ and the $116^\\circ$ exterior angle are a linear pair: interior $= 180^\\circ - 116^\\circ = 64^\\circ$ ✓. Check a second, independent way through the far corners. The two remote interior angles add to the exterior angle, $116^\\circ$, and the three interior angles of any triangle add to $180^\\circ$, so the angle left over at $B$ is $180^\\circ - 116^\\circ = 64^\\circ$ ✓. (Choosing $26^\\circ$ is TAKING THE COMPLEMENT INSTEAD OF THE SUPPLEMENT, $90^\\circ - 64^\\circ$ ✗; $244^\\circ$ is SUBTRACTING FROM A FULL TURN instead of a half turn ✗ — and no angle of a triangle can exceed $180^\\circ$; $116^\\circ$ is COPYING THE EXTERIOR ANGLE STRAIGHT BACK ✗.)',
    },
    {
  ...
  [
    {
      ...
      answer: 2,
      solution:
        'Maya ends up facing exactly the way she started, and the only turning she did was at the three corners, so her three turns add up to one full spin: $360^\\circ$ ✓. Check a second, independent way with arithmetic instead of walking. At each corner the interior and exterior angles form a straight line, so the three pairs together measure $3 \\times 180^\\circ = 540^\\circ$. The interior angles of a triangle account for $180^\\circ$ of that, which leaves $540^\\circ - 180^\\circ = 360^\\circ$ for the exterior angles ✓. Notice that the $180^\\circ$ subtracted is the same for every triangle, which is why the total never moves. (Choosing $540^\\circ$ is FORGETTING TO SUBTRACT THE INTERIOR SUM from the three straight angles ✗; $180^\\circ$ is CONFUSING THE INTERIOR SUM WITH THE EXTERIOR SUM ✗; "It changes when the triangle changes shape" is TREATING THE TOTAL AS SHAPE-DEPENDENT, missing that the subtraction removes the same $180^\\circ$ every time ✗.)',
    },
    {
  ...
  [
    {
      ...
      answer: 3,
      solution:
        'Set the exterior angle equal to the sum of its two remote interiors: $5x = 48^\\circ + 2x + 30^\\circ$, so $3x = 78^\\circ$ and $x = 26^\\circ$. The exterior angle is $5(26^\\circ) = 130^\\circ$ ✓. Check a second, independent way by building the equation out of the interior angle sum instead. The interior angle at $B$ is $180^\\circ - 5x$, and the three interior angles must total $180^\\circ$: $48^\\circ + (2x + 30^\\circ) + (180^\\circ - 5x) = 180^\\circ$, which tidies to $258^\\circ - 3x = 180^\\circ$, so $x = 26^\\circ$ again ✓. The remotes are then $48^\\circ$ and $82^\\circ$, and $48 + 82 = 130$ ✓. (Choosing $26^\\circ$ is STOPPING AT X instead of answering the question asked ✗; $50^\\circ$ is ANSWERING WITH THE INTERIOR ANGLE AT THE VERTEX ✗; $82^\\circ$ is ANSWERING WITH A REMOTE ANGLE ✗.)',
    },
    {
    ...
    },
    {
      ...
      answer: 1,
      solution:
        'The exterior angle equals the sum of the remotes: $7x = 40^\\circ + 3x + 24^\\circ$, so $4x = 64^\\circ$ and $x = 16^\\circ$. The exterior angle is $7(16^\\circ) = 112^\\circ$ ✓. Check a second, independent way through the interior angle sum. The interior angle at $B$ is $180^\\circ - 7x$, so $40^\\circ + (3x + 24^\\circ) + (180^\\circ - 7x) = 180^\\circ$, which simplifies to $244^\\circ - 4x = 180^\\circ$ and $x = 16^\\circ$ ✓. The remotes come out as $40^\\circ$ and $72^\\circ$, and $40 + 72 = 112$ ✓. (Choosing $16^\\circ$ is STOPPING AT X ✗; $68^\\circ$ is ANSWERING WITH THE INTERIOR ANGLE AT THE VERTEX ✗; $72^\\circ$ is ANSWERING WITH A REMOTE ANGLE ✗.)',
    },
  ],
  ...
  [
    ...
    },
    {
      ...
      answer: 2,
      solution:
        'The three exterior angles, one per vertex, always total $360^\\circ$, so the missing one is $360^\\circ - 138^\\circ - 119^\\circ = 103^\\circ$ ✓. Check a second, independent way using only interior angles. The interiors beside the given exteriors measure $180^\\circ - 138^\\circ = 42^\\circ$ and $180^\\circ - 119^\\circ = 61^\\circ$, so the last interior angle is $180^\\circ - 42^\\circ - 61^\\circ = 77^\\circ$, and the exterior angle beside it is $180^\\circ - 77^\\circ = 103^\\circ$ ✓. (Choosing $283^\\circ$ is FORGETTING TO SUBTRACT THE INTERIOR SUM, treating $540^\\circ$ as the exterior total ✗; $77^\\circ$ is ANSWERING WITH THE INTERIOR ANGLE AT THE VERTEX ✗; $257^\\circ$ is USING THE REMOTE INTERIORS IN PLACE OF THE EXTERIORS ✗.)',
    },
  ],
  ...
  [
    {
      ...
      answer: 2,
      solution:
        'Ignore the big triangle and look only at triangle $ABD$. Side $BD$ runs on to $C$, so $\\angle ADC$ is the exterior angle of triangle $ABD$ at $D$, and its remote interiors are $\\angle ABD$ and $\\angle BAD$: $\\angle ADC = 42^\\circ + 55^\\circ = 97^\\circ$ ✓. Check a second, independent way with the angle sum and a straight line. Inside triangle $ABD$, $\\angle ADB = 180^\\circ - 42^\\circ - 55^\\circ = 83^\\circ$; since $B$, $D$, $C$ lie on one line, $\\angle ADC = 180^\\circ - 83^\\circ = 97^\\circ$ ✓. Nothing about $\\angle C$ was ever needed. (Choosing $13^\\circ$ is SUBTRACTING THE REMOTES INSTEAD OF ADDING ✗; $83^\\circ$ is ANSWERING THE OTHER PIECE OF THE STRAIGHT ANGLE, giving $\\angle ADB$ ✗; $125^\\circ$ is SUPPLEMENTING A REMOTE ANGLE, $180^\\circ - 55^\\circ$ ✗.)',
    },
    {
    ...
    },
    {
      ...
      answer: 2,
      solution:
        'Work inside triangle $ABD$ only. Because $D$ lies on $BC$, the side $BD$ extends past $D$ to $C$, which makes $\\angle ADC$ an exterior angle of triangle $ABD$: $\\angle ADC = \\angle ABD + \\angle BAD = 34^\\circ + 81^\\circ = 115^\\circ$ ✓. Check a second, independent way with a linear pair: $\\angle ADB = 180^\\circ - 34^\\circ - 81^\\circ = 65^\\circ$, and $\\angle ADB$ and $\\angle ADC$ together make the straight angle $\\angle BDC$, so $\\angle ADC = 180^\\circ - 65^\\circ = 115^\\circ$ ✓. (Choosing $47^\\circ$ is SUBTRACTING THE REMOTES INSTEAD OF ADDING ✗; $99^\\circ$ is SUPPLEMENTING A REMOTE ANGLE, $180^\\circ - 81^\\circ$ ✗; $65^\\circ$ is ANSWERING THE OTHER PIECE OF THE STRAIGHT ANGLE ✗.)',
    },
  ],
