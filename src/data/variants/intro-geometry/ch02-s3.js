...
const s23 = [
  ...
  [
    ...
    },
    {
      ...
      answer: 1,
      solution:
        'Completing an angle to a right angle is exactly what a complement does, so the answer is $90^\\circ - 47^\\circ = 43^\\circ$ ✓. Check a second, independent way through the supplement. The supplement of $47^\\circ$ is $180^\\circ - 47^\\circ = 133^\\circ$, and dropping one full right angle from that straight angle leaves $133^\\circ - 90^\\circ = 43^\\circ$ ✓. Notice how close $47^\\circ$ sits to $45^\\circ$: it is $2^\\circ$ over half of a right angle, so its partner should be $2^\\circ$ under, and $45 - 2 = 43$ ✓. (The choice $53^\\circ$ is USING 100 INSTEAD OF 90 ✗; $47^\\circ$ is REPEATING THE ANGLE ITSELF ✗; $133^\\circ$ is CONFUSING SUPPLEMENTARY WITH COMPLEMENTARY ✗.)',
    },
  ],
  ...
  [
    ...
    },
    {
      ...
      answer: 2,
      solution:
        'All four angles around the crossing point make a full turn of $360^\\circ$, so the other three come to $360^\\circ - 128^\\circ = 232^\\circ$ ✓. Check a second, independent way by working out the three angles separately. Each neighbor of the $128^\\circ$ angle is its supplement, $180^\\circ - 128^\\circ = 52^\\circ$, and the angle across the crossing is its vertical twin, $128^\\circ$. Adding: $52^\\circ + 128^\\circ + 52^\\circ = 232^\\circ$ ✓. (The choice $52^\\circ$ is KEEPING ONLY THE NEIGHBOR ✗; $180^\\circ$ is ANSWERING THE STRAIGHT ANGLE ✗; $104^\\circ$ is SUBTRACTING THE VERTICAL TWIN TWICE, from $360 - 128 - 128$ ✗.)',
    },
    {
  ...
  [
    ...
    },
    {
      ...
      answer: 3,
      solution:
        'Vertical angles are equal, so $9x = 6x + 33^\\circ$. Subtracting $6x$ gives $3x = 33^\\circ$, so $x = 11^\\circ$ and each angle measures $9(11) = 99^\\circ$ ✓. Check a second, independent way by pushing the candidate back through both expressions. If the angle is $99^\\circ$, then $9x = 99$ forces $x = 11$, and the partner expression reads $6(11) + 33 = 99$ ✓, so both descriptions land on the same angle. A further check comes from the neighbor: $180^\\circ - 99^\\circ = 81^\\circ$, and the four angles $99$, $81$, $99$, $81$ add to $360^\\circ$ ✓. Just past $90^\\circ$, so the crossing is close to square but not square — matching the drawing. (The choice $33^\\circ$ is CONFUSING THE GAP WITH THE ANGLE, handing back the constant that the two expressions differ by ✗; $81^\\circ$ is NAMING THE NEIGHBOR ✗; $11^\\circ$ is STOPPING AT x ✗.)',
    },
    {
  ...
  [
    ...
    },
    {
      ...
      answer: 2,
      solution:
        'Call the smaller angle $x$; the larger is $2x$. Supplementary means $x + 2x = 180^\\circ$, so $3x = 180^\\circ$, $x = 60^\\circ$, and the larger angle is $2 \\times 60^\\circ = 120^\\circ$ ✓. Check a second, independent way by testing candidates against the two conditions directly, with no algebra. A larger angle of $120^\\circ$ has supplement $180^\\circ - 120^\\circ = 60^\\circ$, and $120$ is twice $60$ ✓ — both conditions hold. A larger angle of $90^\\circ$ has supplement $90^\\circ$, and $90$ is not twice $90$ ✗. A larger angle of $60^\\circ$ has supplement $120^\\circ$, which is bigger than it, so it is not the larger angle at all ✗. Only $120^\\circ$ survives ✓. (The choice $240^\\circ$ is USING A FULL TURN INSTEAD OF A STRAIGHT ANGLE, from $3x = 360^\\circ$ ✗; $60^\\circ$ is ANSWERING THE SMALLER ANGLE ✗; $90^\\circ$ is SPLITTING THE STRAIGHT ANGLE EVENLY and ignoring the doubling ✗.)',
    },
  ],
