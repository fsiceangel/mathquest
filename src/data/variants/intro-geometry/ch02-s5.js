...
const s25 = [
  ...
  [
    {
      ...
      answer: 0,
      solution:
        'The right angle has already spent $90^\\circ$ of the triangle’s $180^\\circ$, so the two acute angles share the other $90^\\circ$ — they are complementary. That gives $\\angle N = 90^\\circ - 28^\\circ = 62^\\circ$ ✓. Check a second, independent way by folding a copy: trace the triangle, flip the copy over the slanted side $LN$, and set it against the original. The two triangles snap together into a rectangle with $LM$ and $MN$ as two of its sides. At corner $L$ of that rectangle the slanted side acts as a diagonal, cutting the rectangle’s square corner into two pieces — the original $28^\\circ$ and a copy of the angle at $N$. Two pieces filling a square corner must total $90^\\circ$, so the copy of $\\angle N$ is $62^\\circ$, and so is $\\angle N$ ✓. (The choice $28^\\circ$ is ASSUMING THE TWO ACUTE ANGLES ARE EQUAL, which happens only in a $45$-$45$-$90$ triangle ✗; $78^\\circ$ is SUBTRACTING DIGIT BY DIGIT WITHOUT REGROUPING, reading $90 - 28$ as $9 - 2 = 7$ and $8 - 0 = 8$ ✗; $152^\\circ$ is FORGETTING THE RIGHT ANGLE and subtracting from $180^\\circ$ ✗.)',
    },
    {
    ...
    },
    {
      ...
      answer: 1,
      solution:
        'The right angle at $D$ claims $90^\\circ$, so the two acute angles split the remaining $90^\\circ$: $\\angle F = 90^\\circ - 66^\\circ = 24^\\circ$ ✓. Check a second, independent way with parallel lines instead of the angle sum. Slide the vertical leg $DE$ sideways until it passes through $F$; the slid copy is parallel to the original, so the slanted side $EF$ crosses it at the same $66^\\circ$ by corresponding angles. At $F$ that vertical copy and the horizontal leg $DF$ meet in a square corner worth $90^\\circ$, and $66^\\circ$ of it lies above the slanted side, leaving $90^\\circ - 66^\\circ = 24^\\circ$ below it — and that leftover is exactly $\\angle F$ ✓. (The choice $114^\\circ$ is FORGETTING THE RIGHT ANGLE, subtracting from $180^\\circ$ ✗; $156^\\circ$ is ADDING TO THE RIGHT ANGLE INSTEAD OF SUBTRACTING, computing $90 + 66$ ✗; $66^\\circ$ is ASSUMING THE TWO ACUTE ANGLES ARE EQUAL ✗.)',
    },
  ],
  ...
  [
    ...
    },
    {
      ...
      answer: 0,
      solution:
        'Start with $\\angle L = 180^\\circ - 60^\\circ - 36^\\circ = 84^\\circ$. The bisector splits it into two pieces of $\\frac{84^\\circ}{2} = 42^\\circ$. Triangle $JML$ holds $60^\\circ$ at $J$ and $42^\\circ$ at $L$, so $\\angle JML = 180^\\circ - 60^\\circ - 42^\\circ = 78^\\circ$ ✓. Check a second, independent way with triangle $KML$: its angles are $36^\\circ$ at $K$ and $42^\\circ$ at $L$, so $\\angle KML = 180^\\circ - 36^\\circ - 42^\\circ = 102^\\circ$. The points $J$, $M$, $K$ lie in a straight line, so the two angles at $M$ complete a straight angle: $\\angle JML = 180^\\circ - 102^\\circ = 78^\\circ$ ✓. Notice this one is the acute angle at $M$, because $\\angle J$ is the larger of the two base angles. (The choice $36^\\circ$ is FORGETTING TO BISECT and using the whole $84^\\circ$, which lands back on $\\angle K$ ✗; $42^\\circ$ is ANSWERING THE HALF-ANGLE ITSELF ✗; $102^\\circ$ is ANSWERING THE ANGLE ON THE OTHER SIDE of $M$ ✗.)',
    },
  ],
