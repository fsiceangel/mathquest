  ...
  [
    {
      ...
      answer: 1,
      solution:
        'The hourglass triangles $\\triangle PAB$ and $\\triangle PCD$ are similar by AA (alternate angles from the parallels, vertical angles at $P$), so $BP : PD = AB : DC = 7 : 14 = 1 : 2$. Then $BP$ is $\\frac{1}{1 + 2} = \\frac{1}{3}$ of the diagonal: $BP = \\frac{1}{3} \\times 33 = 11$ ✓ (and $PD = 22$, with $11 + 22 = 33$ ✓). Check a second, independent way by solving: let $BP = x$, so $\\frac{x}{33 - x} = \\frac{1}{2}$, giving $2x = 33 - x$, $3x = 33$, $x = 11$ ✓. Sanity: $P$ must sit closer to the SHORTER parallel side, and $11 < 22$ ✓. (The choice $16.5$ is ASSUMING THE DIAGONALS BISECT EACH OTHER, which only parallelograms do; the choice $22$ is TAKING THE OTHER PIECE OF THE DIAGONAL, $PD$; the choice $8.25$ is SQUARING THE RATIO OF LENGTHS — squares are for areas, and a diagonal is a length.)',
    },
    {
