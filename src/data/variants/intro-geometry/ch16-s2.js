...
const s162 = [
  ...
  [
    ...
    },
    {
      ...
      answer: 2,
      solution:
        'Route one, the coordinate rule: a $90^\\circ$ counterclockwise turn about the origin is $(x, y) \\to (-y, x)$, so $(-7, -2) \\to (2, -7)$ ✓. Check a second, independent way, by walking the grid: the balloon sits $7$ units west and $2$ units south of the tower. A quarter turn counterclockwise carries west to south and south to east, so the legs become $7$ south and $2$ east, which is the point $(2, -7)$ ✓. (The choice $(-2, -7)$ is SWAPPING THE COORDINATES BUT LEAVING BOTH SIGNS ALONE, a fold over the line $y = x$ rather than a turn ✗; the choice $(-2, 7)$ is TURNING CLOCKWISE, the rule $(x, y) \\to (y, -x)$ ✗; the choice $(7, 2)$ is A HALF TURN INSTEAD OF A QUARTER ✗.)',
    },
    {
  ...
  [
    ...
    },
    {
      ...
      answer: 3,
      solution:
        'Route one, the coordinate rule: a $180^\\circ$ rotation about the origin is $(x, y) \\to (-x, -y)$, so $(6, 13) \\to (-6, -13)$ ✓. Check a second, independent way, through the midpoint: a half turn carries every point straight through the center to the opposite side at the same distance, so the launch pad is the midpoint of the waypoint and its image. The midpoint of $(6, 13)$ and $(-6, -13)$ is $\\left(\\frac{6 - 6}{2}, \\frac{13 - 13}{2}\\right) = (0, 0)$ ✓. (The choice $(-6, 13)$ is NEGATING ONLY THE FIRST COORDINATE, a fold over the $y$-axis ✗; the choice $(-13, 6)$ is A QUARTER TURN, the rule $(x, y) \\to (-y, x)$, which swaps coordinates that a half turn leaves in place ✗; the choice $(6, -13)$ is NEGATING ONLY THE SECOND COORDINATE, a fold over the $x$-axis ✗.)',
    },
  ],
