...
const s101 = [
  ...
  [
    ...
    },
    {
      ...
      answer: 3,
      solution:
        'Rebuild the angle sum: $72^\\circ + 51^\\circ + 57^\\circ = 180^\\circ$ ✓. Order the angles: $\\angle B = 51^\\circ < \\angle C = 57^\\circ < \\angle A = 72^\\circ$. Swap each for its opposite partner: $\\angle B \\leftrightarrow \\overline{AC}$, $\\angle C \\leftrightarrow \\overline{AB}$, $\\angle A \\leftrightarrow \\overline{BC}$, so $AC < AB < BC$ ✓. Check a second, independent way with the endpoints: the shortest edge faces the smallest angle, $51^\\circ$, so it is $\\overline{AC}$; the longest faces $72^\\circ$, so it is $\\overline{BC}$ — only one choice does both ✓. (The choice $BC < AB < AC$ is REVERSING THE MATCH ✗; $AB < AC < BC$ is SWAPPING THE PARTNERS OF THE TWO SMALLER ANGLES ✗; $BC < AC < AB$ is PAIRING EACH ANGLE WITH AN ADJACENT SIDE ✗.)',
    },
    {
