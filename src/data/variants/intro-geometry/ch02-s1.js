...
const s21 = [
  ...
  [
    {
      ...
      answer: 2,
      solution:
        'Ray $\\overrightarrow{OV}$ splits $\\angle UOW$ into two parts, so $\\angle UOV + \\angle VOW = \\angle UOW$ and therefore $\\angle VOW = 85^\\circ - 33^\\circ = 52^\\circ$ ✓. Check a second, independent way by putting the pieces back together: $33^\\circ + 52^\\circ = 85^\\circ$, exactly the whole angle in the figure ✓. Try the same rebuild on the other choices and each one fails — $33^\\circ + 118^\\circ = 151^\\circ$ ✗, $33^\\circ + 33^\\circ = 66^\\circ$ ✗, $33^\\circ + 85^\\circ = 118^\\circ$ ✗ — so only $52^\\circ$ can be the missing piece. (The choice $33^\\circ$ is HANDING BACK A GIVEN PIECE ✗; $118^\\circ$ is ADDING INSTEAD OF SUBTRACTING, and it is larger than the whole angle it is supposed to sit inside ✗; $85^\\circ$ is HANDING BACK THE WHOLE ✗.)',
    },
    {
  ...
  [
    ...
    },
    {
      ...
      answer: 2,
      solution:
        'Let $\\angle HFK = y$, so $\\angle GFH = y + 24^\\circ$. The parts add to the whole: $y + (y + 24^\\circ) = 112^\\circ$, giving $2y = 88^\\circ$, $y = 44^\\circ$, and $\\angle GFH = 44^\\circ + 24^\\circ = 68^\\circ$ ✓. Check a second, independent way by starting from an even split and then tilting it. An even split of $112^\\circ$ would give $56^\\circ$ each; to open one part by $24^\\circ$ more than the other, move $12^\\circ$ across from the smaller to the larger — half the difference, since every degree moved widens the gap by two. That gives $56^\\circ + 12^\\circ = 68^\\circ$ and $56^\\circ - 12^\\circ = 44^\\circ$ ✓, whose difference is $24^\\circ$ ✓ and whose sum is $112^\\circ$ ✓. (The choice $88^\\circ$ is SUBTRACTING THE DIFFERENCE FROM THE WHOLE ✗; $56^\\circ$ is SPLITTING THE WHOLE EVENLY ✗; $44^\\circ$ is ANSWERING THE OTHER PART ✗.)',
    },
  ],
  ...
  [
    ...
    },
    {
      ...
      answer: 1,
      solution:
        'The angles $\\angle WOY$ and $\\angle XOZ$ overlap, and their shared strip is $\\angle XOY$. Adding them counts $\\angle WOZ$ once and the strip twice: $72^\\circ + 68^\\circ = 93^\\circ + \\angle XOY$, so $\\angle XOY = 140^\\circ - 93^\\circ = 47^\\circ$ ✓. Check a second, independent way by working in from the edges with plain subtraction. The far gap is $\\angle YOZ = \\angle WOZ - \\angle WOY = 93^\\circ - 72^\\circ = 21^\\circ$, so $\\angle XOY = \\angle XOZ - \\angle YOZ = 68^\\circ - 21^\\circ = 47^\\circ$ ✓. Rebuild for safety: the near gap is $\\angle WOX = 93^\\circ - 68^\\circ = 25^\\circ$, and $25^\\circ + 47^\\circ + 21^\\circ = 93^\\circ$ ✓. (The choice $21^\\circ$ is ANSWERING THE LAST GAP $\\angle YOZ$ ✗; $25^\\circ$ is ANSWERING THE FIRST GAP $\\angle WOX$ ✗; $140^\\circ$ is FORGETTING THE OVERLAP ✗.)',
    },
  ],
