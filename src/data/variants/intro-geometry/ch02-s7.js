...
const s27 = [
  ...
  [
    ...
    },
    {
      ...
      answer: 1,
      solution:
        'Step one: the transversal $GH$ makes $62^\\circ$ with $\\ell$, so it makes $62^\\circ$ with $m$ at $H$ as well — $\\angle GHJ = 62^\\circ$ by alternate interior angles. Step two: the triangle sum in $GHJ$ gives $\\angle HGJ = 180^\\circ - 95^\\circ - 62^\\circ = 23^\\circ$ ✓. Check a second, independent way by adding up the angles sitting on $\\ell$ at $G$: the given $62^\\circ$, then $\\angle HGJ$, then the angle between $GJ$ and $\\ell$ running the other way. That last one is an alternate interior angle of the marked $\\angle GJH$, so it is $95^\\circ$, and the straight line forces $62^\\circ + \\angle HGJ + 95^\\circ = 180^\\circ$, giving $\\angle HGJ = 23^\\circ$ ✓ — no triangle sum required. (The choice $33^\\circ$ is that supplement fed into the triangle sum, $180 - 62 - 85$ ✗; $62^\\circ$ is COPYING A GIVEN ANGLE ✗; $85^\\circ$ is USING THE SUPPLEMENT AT THE MARKED VERTEX, $180 - 95$ ✗.)',
    },
    {
      ...
      answer: 3,
      solution:
        'Step one: alternate interior angles across the parallels copy the $48^\\circ$ from $R$ down to $S$, so $\\angle RST = 48^\\circ$. Step two: the triangle sum in $RST$ gives $\\angle SRT = 180^\\circ - 78^\\circ - 48^\\circ = 54^\\circ$ ✓. Check a second, independent way by working entirely along $\\ell$. At $R$ the straight line carries three angles in a row: the given $48^\\circ$ on one side, then $\\angle SRT$, then the angle between $RT$ and $\\ell$ on the far side, which is an alternate interior angle of the marked $78^\\circ$. So $48^\\circ + \\angle SRT + 78^\\circ = 180^\\circ$ and $\\angle SRT = 54^\\circ$ ✓. (The choice $30^\\circ$ is that supplement pushed through the triangle sum, $180 - 48 - 102$ ✗; $48^\\circ$ is COPYING A GIVEN ANGLE ✗; $102^\\circ$ is USING THE SUPPLEMENT AT THE MARKED VERTEX, $180 - 78$ ✗.)',
    },
  ],
]
