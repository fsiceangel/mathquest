...
const s144 = [
  ...
  [
    ...
    },
    {
      ...
      answer: 2,
      solution:
        'Route one, Euler’s formula: $V - E + F = 2$ becomes $V - 28 + 16 = 2$, so $V = 2 + 28 - 16 = 14$ joints ✓. Check a second, independent way, by soldering a frame that really carries $16$ panels on $28$ wires and counting its joints: set a seven-sided ring above a seven-sided ring, turned so that the band between them is a zigzag of triangles. Panels: the two seven-sided ends plus $14$ triangles, for $16$, and wires: $7$ around the top, $7$ around the bottom, $14$ zigzagging, for $7 + 7 + 14 = 28$. Its joints are the $7$ on the top ring and the $7$ on the bottom ring: $7 + 7 = 14$ ✓. (The choice $44$ is ADDING THE TWO GIVEN NUMBERS, $16 + 28$ ✗; the choice $12$ is FORGETTING THE $2$ and stopping at $28 - 16$ ✗; the choice $46$ is ADDING ALL THREE NUMBERS, $16 + 28 + 2$, instead of following the signs ✗.)',
    },
    {
  ...
  [
    ...
    },
    {
      ...
      answer: 1,
      solution:
        'Route one, Euler’s formula: $V - E + F = 2$ becomes $9 - E + 9 = 2$, so $E = 9 + 9 - 2 = 16$ beams ✓. Check a second, independent way, by raising a pavilion that really has $9$ surfaces and $9$ posts and counting its beams directly: lay an eight-sided floor and draw all eight of its corners up to a single peak. Surfaces: $8$ roof triangles plus the floor, for $9$, and posts: $8$ around the floor plus the peak, for $9$. Its beams are the $8$ around the floor plus the $8$ rising to the peak: $8 + 8 = 16$ ✓. (The choice $18$ is FORGETTING TO SUBTRACT THE $2$ and stopping at $9 + 9$ ✗; the choice $32$ is the total of all the surface sides, $8 \\times 3 + 8$, with NO HALVING for the two surfaces on each beam ✗; the choice $20$ is ADDING THE $2$, $9 + 9 + 2$, when the formula subtracts it ✗.)',
    },
    {
