...
const s124 = [
  ...
  [
    ...
    },
    {
      ...
      answer: 2,
      solution:
        'Route one, the semicircle rule plus the triangle angle sum: the stick passes over the center, so $AB$ is a diameter and $\\angle ACB = 90^\\circ$; the angles of triangle $ABC$ then give $\\angle ABC = 180^\\circ - 90^\\circ - 44^\\circ = 46^\\circ$ ✓. Check a second, independent way, purely with arcs: $\\angle BAC = 44^\\circ$ is inscribed on arc $BC$, so $\\overset{\\frown}{BC} = 88^\\circ$; the diameter makes $\\overset{\\frown}{AC} + \\overset{\\frown}{CB} = 180^\\circ$ on the rosin mark’s side, so $\\overset{\\frown}{AC} = 92^\\circ$ and $\\angle ABC = \\frac{92^\\circ}{2} = 46^\\circ$ ✓. (The choice $136^\\circ$ is FORGETTING THE RIGHT ANGLE and computing $180^\\circ - 44^\\circ$ ✗; the choice $44^\\circ$ is ASSUMING THE TWO ACUTE ANGLES ARE EQUAL ✗; the choice $88^\\circ$ is REPORTING THE ARC $BC$ instead of an angle ✗.)',
    },
    {
