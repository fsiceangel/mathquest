  ...
  [
    {
      ...
      answer: 3,
      solution:
        'Route one, undo the formula: $\\frac{1}{3}\\pi \\cdot 6^2 \\cdot h = 228\\pi$. Taking the third of the squared radius first, $\\frac{1}{3} \\cdot 36 = 12$, so $12h = 228$ and $h = 19$ centimeters ✓. Check a second, independent way, by comparing with a straight-sided tin of the same lid: a tin holding $228\\pi$ would need height $\\frac{228\\pi}{36\\pi} = \\frac{19}{3}$. A cone is only a third as roomy at every depth, so the feeder must reach three times as far down: $3 \\cdot \\frac{19}{3} = 19$. Filling it back confirms it, $\\frac{1}{3}\\pi \\cdot 36 \\cdot 19 = 12 \\cdot 19\\pi = 228\\pi$ ✓. (The choice $\\frac{19}{3}$ is NEVER UNDOING THE $\\frac{1}{3}$, solving $36h = 228$, which measures the straight-sided tin instead ✗; the choice $114$ is DIVIDING BY THE RADIUS INSTEAD OF ITS SQUARE, $\\frac{3 \\cdot 228}{6}$ ✗; the choice $57$ is TRIPLING TWICE, once to clear the fraction and once more for the tin comparison, when either step alone already gets there ✗.)',
    },
    {
  ...
  [
    {
      ...
      answer: 0,
      solution:
        'Route one, follow the arc: the sector takes $\\frac{90}{360} = \\frac{1}{4}$ of the full circumference $2\\pi \\cdot 16 = 32\\pi$, so its curved edge is $8\\pi$ long. Rolled up, that edge becomes the base rim: $2\\pi r = 8\\pi$, so $r = 4$ inches ✓. Check a second, independent way, through areas: the sector is $\\frac{1}{4}$ of a disk of area $\\pi \\cdot 16^2 = 256\\pi$, which is $64\\pi$, and rolling changes no area, so that becomes the cone’s curved surface $\\pi r \\ell$ with $\\ell = 16$. From $16\\pi r = 64\\pi$ we again get $r = 4$ ✓. (The choice $12$ is ROLLING UP THE LEFTOVER $270^\\circ$ PIECE, whose arc is $24\\pi$ ✗; the choice $16$ is REPORTING THE SHEET’S RADIUS, which becomes the slant height, not the base radius ✗; the choice $8$ is DIVIDING THE ARC BY $\\pi$ INSTEAD OF $2\\pi$, which hands back the diameter ✗.)',
    },
    {
      ...
      answer: 2,
      solution:
        'Route one, follow the arc: the sector takes $\\frac{30}{360} = \\frac{1}{12}$ of the full circumference $2\\pi \\cdot 36 = 72\\pi$, so its curved edge is $6\\pi$ long. Rolled up, that edge becomes the base rim: $2\\pi r = 6\\pi$, so $r = 3$ centimeters ✓. Check a second, independent way, through areas: the sector is $\\frac{1}{12}$ of a disk of area $\\pi \\cdot 36^2 = 1296\\pi$, which is $108\\pi$, and rolling changes no area, so it becomes the curved surface $\\pi r \\ell$ with $\\ell = 36$. From $36\\pi r = 108\\pi$ we again get $r = 3$ ✓. (The choice $6$ is DIVIDING THE ARC BY $\\pi$ INSTEAD OF $2\\pi$, which hands back the diameter ✗; the choice $36$ is REPORTING THE ORIGINAL RADIUS, which becomes the slant height ✗; the choice $33$ is ROLLING UP THE LEFTOVER $330^\\circ$ PIECE, whose arc is $66\\pi$ ✗.)',
    },
    {
      ...
      answer: 1,
      solution:
        'Route one, follow the arc: the sector takes $\\frac{108}{360} = \\frac{3}{10}$ of the full circumference $2\\pi \\cdot 40 = 80\\pi$, so its curved edge is $24\\pi$ long. Rolled up, that edge becomes the base rim: $2\\pi r = 24\\pi$, so $r = 12$ feet ✓. Check a second, independent way, through areas: the sector is $\\frac{3}{10}$ of a disk of area $\\pi \\cdot 40^2 = 1600\\pi$, which is $480\\pi$, and rolling changes no area, so it becomes the curved surface $\\pi r \\ell$ with $\\ell = 40$. From $40\\pi r = 480\\pi$ we again get $r = 12$ ✓. (The choice $24$ is DIVIDING THE ARC BY $\\pi$ INSTEAD OF $2\\pi$, which hands back the diameter ✗; the choice $40$ is REPORTING THE TARPAULIN’S RADIUS, which becomes the slant height ✗; the choice $28$ is ROLLING UP THE LEFTOVER $252^\\circ$ PIECE, whose arc is $56\\pi$ ✗.)',
    },
  ],
