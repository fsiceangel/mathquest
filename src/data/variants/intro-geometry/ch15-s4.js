...
const s154 = [
  ...
  [
    ...
    },
    {
      ...
      answer: 0,
      solution:
        'Route one, piece by piece: the wall unrolls into a rectangle $2\\pi \\cdot 7$ wide and $5$ tall, giving $70\\pi$, and the roof is half a sphere’s skin, $\\frac{1}{2} \\cdot 4\\pi \\cdot 49 = 98\\pi$. No flat circle is painted: the floor is bare and the ring where roof meets wall is a seam. Whitewashed: $70\\pi + 98\\pi = 168\\pi$ ✓. Check a second, independent way, by turning the roof into more wall: a hemisphere of radius $7$ has the same curved skin as the side of a cylinder of radius $7$ and height $7$, so the whitewasher faces one unbroken wall of radius $7$ and height $5 + 7 = 12$: $2\\pi \\cdot 7 \\cdot 12 = 168\\pi$ ✓. (The choice $266\\pi$ USES A WHOLE SPHERE’S SKIN, $196\\pi$, though only the top half is out in the weather ✗; the choice $119\\pi$ ROOFS THE HUT WITH A FLAT LID of $49\\pi$ instead of a dome ✗; the choice $217\\pi$ WHITEWASHES THE FLOOR TOO, adding a disk of $49\\pi$ ✗.)',
    },
  ],
