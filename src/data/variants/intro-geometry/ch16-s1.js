...
const s161 = [
  ...
  [
    ...
    },
    {
      ...
      answer: 3,
      solution:
        'Route one, add up the three slides first: since $T$ carries the origin to $(4, -1)$, one turn of $T$ moves any point $4$ right and $1$ down. Three turns move it $3 \\cdot 4 = 12$ right and $3 \\cdot 1 = 3$ down, which is the single slide $(x, y) \\to (x + 12, y - 3)$. From $(-7, 9)$ that gives $(-7 + 12, 9 - 3) = (5, 6)$ ✓. Check a second, independent way, one step at a time: the first move puts the piece at $(-7 + 4, 9 - 1) = (-3, 8)$; the second puts it at $(-3 + 4, 8 - 1) = (1, 7)$; the third puts it at $(1 + 4, 7 - 1) = (5, 6)$ ✓. (The choice $(-3, 8)$ is HALTING AFTER THE FIRST MOVE ✗; the choice $(12, -3)$ is HANDING BACK THE COMBINED SLIDE rather than the point it acts on ✗; the choice $(1, 7)$ is HALTING AFTER THE SECOND MOVE ✗.)',
    },
    {
