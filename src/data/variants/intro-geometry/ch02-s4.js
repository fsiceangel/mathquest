...
const s24 = [
  ...
  [
    ...
    },
    {
      ...
      answer: 2,
      solution:
        'Call the angles $8k$ and $7k$. They are same-side interior angles, so they are supplementary: $15k = 180^\\circ$ and $k = 12^\\circ$. The angles are $96^\\circ$ and $84^\\circ$, and the acute one is $84^\\circ$ ✓. Check a second, independent way by splitting the difference around $90^\\circ$. Two supplementary angles always sit at equal distances either side of $90^\\circ$, so the acute one is $90^\\circ - g$ and the obtuse one is $90^\\circ + g$ for some gap $g$; their ratio $\\frac{90 + g}{90 - g} = \\frac{8}{7}$ gives $630 + 7g = 720 - 8g$, so $15g = 90$ and $g = 6^\\circ$, making the acute angle $90^\\circ - 6^\\circ = 84^\\circ$ ✓. (The choice $96^\\circ$ is the OBTUSE partner ✗; $42^\\circ$ is SHARING 90 INSTEAD OF 180, from $15k = 90^\\circ$ ✗; $12^\\circ$ is ANSWERING k INSTEAD OF THE ANGLE ✗.)',
    },
    {
