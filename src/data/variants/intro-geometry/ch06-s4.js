...
const s64 = [
  ...
  [
    ...
    },
    {
      ...
      answer: 1,
      solution:
        'Complements first: the truss carries $33^\\circ$, $90^\\circ - 33^\\circ = 57^\\circ$, and $90^\\circ$. A right triangle with a $57^\\circ$ angle must complete itself with $33^\\circ$, so the two trusses match in two angles — AA, and size never enters the argument ✓. Check a second, independent way with the angle sum: $33^\\circ + 57^\\circ + 90^\\circ = 180^\\circ$ ✓, whereas a right triangle with $66^\\circ$ carries $24^\\circ$, with $45^\\circ$ carries $45^\\circ$, and with $16.5^\\circ$ carries $73.5^\\circ$ — none of them owns a $33^\\circ$ angle, so none is forced into the first truss’s family ✗. (The choice $66^\\circ$ is DOUBLING THE ANGLE rather than subtracting it from $90^\\circ$ ✗; $45^\\circ$ is TRUSTING THE $45$-DEGREE DEFAULT ✗; $16.5^\\circ$ is HALVING THE ANGLE ✗.)',
    },
  ],
  ...
  [
    ...
    },
    {
      ...
      answer: 2,
      solution:
        'Run the geometric-mean relation backward: $8^2 = 2 \\times q$, so the far piece is $q = \\frac{64}{2} = 32$, and the hypotenuse totals $2 + 32 = 34$ ✓. Check a second, independent way with a Pythagorean closure: the two legs satisfy $2^2 + 8^2 = 68$ and $8^2 + 32^2 = 1088$, and $68 + 1088 = 1156 = 34^2$ ✓ — only the correct far piece makes the corner a true right angle. (The choice $32$ is KEEPING ONLY THE OTHER PIECE — the question asks for the whole hypotenuse ✗; $10$ is LAYING THE ALTITUDE ALONG THE HYPOTENUSE, adding $8 + 2$ even though the altitude sticks out perpendicular to it ✗; $30$ is SUBTRACTING THE PIECES, $32 - 2$ ✗.)',
    },
    {
