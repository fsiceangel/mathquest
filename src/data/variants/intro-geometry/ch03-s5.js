...
const s36 = [
  ...
  [
    ...
    },
    {
      ...
      answer: 0,
      solution:
        'All $38$ inches of rod go into two equal sides plus the base. Remove the base: $38 - 6 = 32$ inches for the pair, so each equal rod is $\\frac{32}{2} = 16$ inches ✓. Check a second, independent way with the fold. Creasing from $T$ to the midpoint of $\\overline{RS}$ splits the whole rim into two identical halves of $\\frac{38}{2} = 19$ inches each, and each half is one full rod plus half the base, $\\frac{6}{2} = 3$ inches. So a rod is $19 - 3 = 16$ inches ✓. Triangle inequality: $16 + 16 = 32 > 6$ ✓. (The choice $32$ is FORGETTING TO SPLIT THE LEFTOVER BETWEEN THE TWO LEGS ✗; $22$ is ADDING THE BASE INSTEAD OF SUBTRACTING, computing $\\frac{38 + 6}{2}$ ✗; $19$ is HALVING THE PERIMETER and stopping there ✗.)',
    },
  ],
