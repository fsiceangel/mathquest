  ...
  [
    {
      ...
      answer: 0,
      solution:
        'Route one, the pyramid volume formula: the base is a $9 \\times 9$ square, so $B = 81$, and $V = \\frac{1}{3}Bh$. Taking the third first, $\\frac{81}{3} = 27$, and $27 \\times 4 = 108$ cubic centimeters ✓. Check a second, independent way, through the matching box: the square prism standing on the same $9 \\times 9$ base with the same height $4$ holds $81 \\times 4 = 324$ cubic centimeters, and three pyramid-loads pour into that prism exactly, so one load is $324 \\div 3 = 108$ ✓. (The choice $324$ is REPORTING THE MATCHING PRISM and never taking the third ✗; the choice $36$ is MULTIPLYING THE BASE EDGE BY THE HEIGHT and never squaring the edge to get the base area ✗; the choice $162$ is HALVING THE PRISM instead of thirding it ✗.)',
    },
    {
