...
const s94 = [
  ...
  [
    ...
    },
    {
      ...
      answer: 2,
      solution:
        'The square and hexagon cover $90^\\circ + 120^\\circ = 210^\\circ$ at $P$, leaving $360^\\circ - 210^\\circ = 150^\\circ$. A regular dodecagon’s interior angle is $180^\\circ - \\frac{360^\\circ}{12} = 150^\\circ$ — a perfect fit ✓. Check a second, independent way by recomputing the dodecagon’s angle from the sum formula, $\\frac{(12 - 2) \\cdot 180^\\circ}{12} = \\frac{1800^\\circ}{12} = 150^\\circ$, and testing the others against the gap: the decagon’s $144^\\circ$ leaves a $6^\\circ$ sliver, the hexagon’s $120^\\circ$ leaves $30^\\circ$, the pentagon’s $108^\\circ$ leaves $42^\\circ$ ✓. (The choice "a regular hexagon" UNDERSHOOTS by $30^\\circ$ ✗; "a regular decagon" UNDERSHOOTS THE GAP by $6^\\circ$ ✗; "a regular pentagon" UNDERSHOOTS by $42^\\circ$ ✗.)',
    },
    {
