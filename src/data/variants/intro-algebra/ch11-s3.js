...
const s115 = [
  ...
  [
    ...
    },
    {
      ...
      answer: 2,
      solution:
        'Add the magic constant $3 \\cdot 2 = 6$ to both sides: $(x + 2)(y + 3) = 128$. Since $128 = 2^7$, its divisors are $1, 2, 4, 8, 16, 32, 64, 128$ — a tidy list to sweep. We need $x + 2 \\geq 3$ and $y + 3 \\geq 4$. Check each ordered pair: $4 \\times 32$ ✓ gives $(2, 29)$ with $x + y = 31$; $8 \\times 16$ ✓ gives $(6, 13)$ with sum $19$; $16 \\times 8$ ✓ gives $(14, 5)$ with sum $19$; $32 \\times 4$ ✓ gives $(30, 1)$ with sum $31$; and $1 \\times 128$, $2 \\times 64$ fail the first bar while $64 \\times 2$, $128 \\times 1$ fail the second. Four pairs survive, and the largest sum is $31$ ✓. Check $(30, 1)$: $30 + 90 + 2 = 122$ ✓, and check $(2, 29)$: $58 + 6 + 58 = 122$ ✓. (The choice $61$ comes from allowing $2 \\times 64$, which gives $x = 0$, or $64 \\times 2$, which gives $y = -1$ — neither is a positive integer; the choice $19$ is the sum from the balanced pairs, which is the SMALLEST one, not the largest; the choice $124$ comes from allowing $128 \\times 1$, which makes $y = -2$.)',
    },
  ],
]
