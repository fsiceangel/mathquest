...
const s223 = [
  ...
  [
    ...
    },
    {
      ...
      answer: 3,
      solution:
        'The difference identity needs four copies of the product: $(x - y)^2 = (x + y)^2 - 4xy = 169 - 88 = 81$ ✓. Check a second, independent way by finding the numbers: $t^2 - 13t + 22 = 0 = (t - 2)(t - 11)$, so they are $2$ and $11$, and $(2 - 11)^2 = 81$ ✓. (The choice $169$ is FORGETTING TO SUBTRACT; the choice $125$ is SUBTRACTING ONLY $2xy$, which computes $x^2 + y^2 = 4 + 121$; the choice $9$ is ANSWERING WITH THE ROOT — $|x - y| = 9$ is true, but it is not the square.)',
    },
  ],
